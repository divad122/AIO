...
const ProPlan: React.FC<PlanPageProps> = ({ onBack, content }) => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4">
             ...
             <div className="bg-brand-accent text-brand-dark px-3 py-1 text-sm font-semibold rounded-full">{content.popular}</div>
          </div>
          <p className="mt-4 text-xl text-gray-300">{content.description}</p>
          
          <div className="mt-10 grid md:grid-cols-3 gap-8 p-8 bg-brand-light-dark border border-brand-accent rounded-2xl shadow-2xl shadow-brand-accent/20">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">{content.features_prefix}</h3>
                  </div>
                </li>
