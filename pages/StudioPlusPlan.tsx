...
const StudioPlusPlan: React.FC<PlanPageProps> = ({ onBack, content }) => {
  return (
          ...
          <div className="mt-12 grid lg:grid-cols-2 gap-x-12 gap-y-10">
            <div>
              ...
              <ul className="space-y-4">
                 <li className="flex items-start">
                    ...
                    <div><h3 className="font-semibold text-white">{content.features_prefix}</h3></div>
                </li>
            ...
            <div>
              <div className="p-8 bg-brand-dark/50 border border-gray-800 rounded-lg h-full flex flex-col">
                ...
                <button onClick={() => onBack('cta')} className="mt-auto block w-full text-center py-3 px-6 rounded-lg font-semibold transition-transform hover:scale-105 transform-gpu bg-brand-light-dark text-white hover:bg-gray-800 border border-gray-700">
                  {content.cta}
                </button>
              </div>
            </div>
